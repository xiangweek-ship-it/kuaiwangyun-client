...
class AppLocalizations {
  ...
  /// `Password`
  String get kwPassword {
    return Intl.message('Password', name: 'kwPassword', desc: '', args: []);
  }
  ...
  String get kwInvalidCredentials {
    return Intl.message(
      'Incorrect credentials or disabled account',
      name: 'kwInvalidCredentials',
      desc: '',
      args: [],
    );
  }
  ...
  String get kwSessionExpired {
    return Intl.message(
      'Your session expired. Sign in again.',
      name: 'kwSessionExpired',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Member until`
  String get kwMembershipUntil {
    return Intl.message(
      'Member until',
      name: 'kwMembershipUntil',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Sync routes`
  String get kwSync {
    return Intl.message('Sync routes', name: 'kwSync', desc: '', args: []);
  }

  /// `Account / registration / support`
  String get kwAccountWebsite {
    return Intl.message(
      'Account / registration / support',
      name: 'kwAccountWebsite',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Sign out`
  String get kwLogout {
    return Intl.message('Sign out', name: 'kwLogout', desc: '', args: []);
  }

  /// `No routes are available. Contact support.`
  String get kwNoSources {
    return Intl.message(
      'No routes are available. Contact support.',
      name: 'kwNoSources',
      desc: '',
  ...
  String get kwMembershipRequired {
    return Intl.message(
      'Activate or renew your membership',
      name: 'kwMembershipRequired',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Refresh membership`
  String get kwRefreshMembership {
    return Intl.message(
      'Refresh membership',
      name: 'kwRefreshMembership',
      desc: '',
      args: [],
    );
  }
