...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "kwAccountWebsite": MessageLookupByLibrary.simpleMessage("账号管理 / 注册 / 客服"),
    "kwCoreNotReady": MessageLookupByLibrary.simpleMessage("连接服务尚未就绪，请稍后点击同步"),
    "kwInvalidCredentials": MessageLookupByLibrary.simpleMessage(
      "用户名或密码错误，或账号已停用",
    ),
    "kwLogin": MessageLookupByLibrary.simpleMessage("登录并同步线路"),
    "kwLogout": MessageLookupByLibrary.simpleMessage("退出登录"),
    "kwMembershipRequired": MessageLookupByLibrary.simpleMessage("会员尚未激活或已到期"),
    "kwMembershipUntil": MessageLookupByLibrary.simpleMessage("会员至"),
    "kwNetworkError": MessageLookupByLibrary.simpleMessage("暂时无法连接服务，请检查网络后重试"),
    "kwNoSources": MessageLookupByLibrary.simpleMessage("暂时没有可用线路，请联系客服"),
    "kwPartialSync": MessageLookupByLibrary.simpleMessage("部分线路更新失败，请稍后点击同步重试"),
    "kwPassword": MessageLookupByLibrary.simpleMessage("密码"),
    "kwPrivacy": MessageLookupByLibrary.simpleMessage(
      "密码不会保存在客户端；登录凭据由系统安全存储保护。",
    ),
    "kwRateLimited": MessageLookupByLibrary.simpleMessage("尝试次数过多，请 10 分钟后再试"),
    "kwRefreshMembership": MessageLookupByLibrary.simpleMessage("刷新会员状态"),
    "kwRenew": MessageLookupByLibrary.simpleMessage("前往网站激活 / 续费"),
    "kwSessionExpired": MessageLookupByLibrary.simpleMessage("登录已失效，请重新登录"),
    "kwShowPassword": MessageLookupByLibrary.simpleMessage("显示或隐藏密码"),
    "kwSync": MessageLookupByLibrary.simpleMessage("同步线路"),
    "kwUsername": MessageLookupByLibrary.simpleMessage("网站用户名"),
    "kwWelcome": MessageLookupByLibrary.simpleMessage("登录快网云，选择线路即可连接"),
