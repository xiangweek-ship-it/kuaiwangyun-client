...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "kwAccountWebsite": MessageLookupByLibrary.simpleMessage(
      "Аккаунт / регистрация / поддержка",
    ),
    "kwCoreNotReady": MessageLookupByLibrary.simpleMessage(
      "Служба подключения ещё не готова. Повторите позже",
    ),
    "kwInvalidCredentials": MessageLookupByLibrary.simpleMessage(
      "Неверные данные или аккаунт отключён",
    ),
    "kwLogin": MessageLookupByLibrary.simpleMessage("Войти и синхронизировать"),
    "kwLogout": MessageLookupByLibrary.simpleMessage("Выйти"),
    "kwMembershipRequired": MessageLookupByLibrary.simpleMessage(
      "Активируйте или продлите подписку",
    ),
    "kwMembershipUntil": MessageLookupByLibrary.simpleMessage("Подписка до"),
    "kwNetworkError": MessageLookupByLibrary.simpleMessage(
      "Сервис недоступен. Проверьте сеть",
    ),
    "kwNoSources": MessageLookupByLibrary.simpleMessage(
      "Нет доступных линий. Обратитесь в поддержку",
    ),
    "kwPartialSync": MessageLookupByLibrary.simpleMessage(
      "Не все линии обновлены. Повторите синхронизацию",
    ),
    "kwPassword": MessageLookupByLibrary.simpleMessage("Пароль"),
    "kwPrivacy": MessageLookupByLibrary.simpleMessage(
      "Пароль не сохраняется. Сессия защищена системным хранилищем.",
    ),
    ...
    "kwRenew": MessageLookupByLibrary.simpleMessage(
      "Активировать / продлить на сайте",
    ),
    ...
    "kwSync": MessageLookupByLibrary.simpleMessage("Синхронизация линий"),
    "kwUsername": MessageLookupByLibrary.simpleMessage(
      "Имя пользователя сайта",
    ),
    "kwWelcome": MessageLookupByLibrary.simpleMessage(
      "Войдите, синхронизируйте линии и подключайтесь",
    ),
