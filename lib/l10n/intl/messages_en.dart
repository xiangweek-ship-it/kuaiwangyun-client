...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "kwAccountWebsite": MessageLookupByLibrary.simpleMessage(
      "Account / registration / support",
    ),
    "kwCoreNotReady": MessageLookupByLibrary.simpleMessage(
      "Connection service is not ready. Try syncing shortly.",
    ),
    "kwInvalidCredentials": MessageLookupByLibrary.simpleMessage(
      "Incorrect credentials or disabled account",
    ),
    "kwLogin": MessageLookupByLibrary.simpleMessage("Sign in and sync"),
    "kwLogout": MessageLookupByLibrary.simpleMessage("Sign out"),
    "kwMembershipRequired": MessageLookupByLibrary.simpleMessage(
      "Activate or renew your membership",
    ),
    "kwMembershipUntil": MessageLookupByLibrary.simpleMessage("Member until"),
    "kwNetworkError": MessageLookupByLibrary.simpleMessage(
      "Cannot reach the service. Check your network and retry.",
    ),
    "kwNoSources": MessageLookupByLibrary.simpleMessage(
      "No routes are available. Contact support.",
    ),
    "kwPartialSync": MessageLookupByLibrary.simpleMessage(
      "Some routes could not update. Try syncing again.",
    ),
    "kwPassword": MessageLookupByLibrary.simpleMessage("Password"),
    "kwPrivacy": MessageLookupByLibrary.simpleMessage(
      "Connects to Kuaiwangyun account services. Your password is not stored; your session is protected by system secure storage.",
    ),
    "kwRateLimited": MessageLookupByLibrary.simpleMessage(
      "Too many attempts. Retry in 10 minutes.",
    ),
    "kwRefreshMembership": MessageLookupByLibrary.simpleMessage(
      "Refresh membership",
    ),
    "kwRenew": MessageLookupByLibrary.simpleMessage(
      "Activate / renew on website",
    ),
    "kwSessionExpired": MessageLookupByLibrary.simpleMessage(
      "Your session expired. Sign in again.",
    ),
    "kwShowPassword": MessageLookupByLibrary.simpleMessage(
      "Show or hide password",
    ),
    "kwSync": MessageLookupByLibrary.simpleMessage("Sync routes"),
    "kwUsername": MessageLookupByLibrary.simpleMessage("Website username"),
    "kwWelcome": MessageLookupByLibrary.simpleMessage(
      "Sign in, sync your routes, and connect",
    ),
